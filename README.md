...
* `NEW`: The "Spring26" release of the "Identity and Consent Management" guidelines and documentation for the CAMARA APIs is available under the tag [r4.2](https://github.com/camaraproject/IdentityAndConsentManagement/tree/r4.2). It contains the release candidate [version](https://github.com/camaraproject/IdentityAndConsentManagement/blob/r4.2/VERSION.yaml) of the documents which are relevant for the [Spring26 meta-release](https://lf-camaraproject.atlassian.net/wiki/spaces/CAM/pages/268500993/Spring26+meta-release), including:
