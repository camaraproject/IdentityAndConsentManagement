...
The subject identifier must be globally unique identifier and a case-sensitive ASCII string with a maximum length of 255. The sub value MUST not contain the MSISDN. Within Camara this is populated by a Pseudonymous Customer Reference (PCR) which is a system-facing unique identifier that links a User’s MSISDN/IP-Address to a ASP. It is generated by the OP.
