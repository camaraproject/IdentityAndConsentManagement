...
**PLEASE NOTE: This document is part of Identity & Consent Management (ICM) v0.1.0. It is deprecated as the content is now included within [CAMARA-API-access-and-user-consent.md](https://github.com/camaraproject/IdentityAndConsentManagement/blob/main/documentation/CAMARA-API-access-and-user-consent.md). It will be deleted after the release of Commonalities v0.4.0 and Identity & Consent Management v0.2.0. 
The document is here preserved for now as Commonalities v0.3.0 and Identity & Consent Management v0.1.0 are referring to this document.**
